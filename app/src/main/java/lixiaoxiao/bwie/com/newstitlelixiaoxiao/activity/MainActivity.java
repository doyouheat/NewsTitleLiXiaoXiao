...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
       ...
       slidingMenu.setMenu(R.layout.side_pull_layout);
        ...
        nick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              shareAPI.get(MainActivity.this).doOauthVerify(MainActivity.this, SHARE_MEDIA.QQ,umAuthListener );
               //
            }
        });
    }
    ...
    private UMAuthListener umAuthListener = new UMAuthListener() {
        ...
        public void onComplete(SHARE_MEDIA platform, int action, Map<String, String> data) {
            ...
            shareAPI .getPlatformInfo(MainActivity.this, SHARE_MEDIA.QQ,umAuthListener);
